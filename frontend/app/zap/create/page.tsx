    ...
    return <div>
        ...
        <div className="flex justify-end bg-slate-200 p-4">
            <PrimaryButton onClick={async () => {
                ...
                const response = await axios.post(`${BACKEND_URL}/api/vi/zap`, {
                    "avalibletriggerId": selectedTrigger.id,
                    "triggerMetadata": {},
        ...
        <div className="w-full min-h-screen bg-slate-200 flex flex-col justify-center">
            ...
            <div className="w-full pt-2 pb-2">
                {selectedActions.map((action, index) => <div className="pt-2 flex justify-center " key={action.index}> <ZapCell onClick={() => {
